...
public class ChangePass extends javax.swing.JFrame {
    ...
    public ChangePass() {
        initComponents();
        jLabelTenTK.setText("Tên tài khoản: "+ Login.tenDN);
    }
    ...
    private void initComponents() {
        ...
        jLabelTenTK = new javax.swing.JLabel();
        ...
        jLabelTenTK.setBackground(new java.awt.Color(204, 153, 255));
        jLabelTenTK.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabelTenTK.setText("Tên tài khoản");
        ...
        jButtonXacNhan.setBackground(new java.awt.Color(204, 153, 255));
        jButtonXacNhan.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jButtonXacNhan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/thuchien.png"))); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jButtonXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(145, 145, 145))
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(24, 24, 24)
                .addComponent(jButtonXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jButtonXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonXacNhanActionPerformed
        ...
        if(pass1.length()==0 || pass2.length()==0){
            JOptionPane.showMessageDialog(null, "Bạn cần nhập đầy đủ các mục", "Thông báo", 2);
        }else if(pass1.equals(pass2)){
            if(nhanvienManager.doiMatKhau(Login.maNV, pass1)){
                JOptionPane.showMessageDialog(null, "Đã đổi mật khẩu!", "Thông báo", 1);
                Login login = new Login();
                this.setVisible(false);
                login.setVisible(true);
            }else JOptionPane.showMessageDialog(null, "Có lỗi xảy ra!", "Thông báo", 2);
            
        }else JOptionPane.showMessageDialog(null, "Mật khẩu không trùng khớp", "Thông báo", 2);
    ...
    private javax.swing.JLabel jLabelTenTK;
